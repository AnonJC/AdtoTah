					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item active"><a href="{{\route('site.home')}}">Home</a></li>
								<li class="main_nav_item"><a href="{{\route('site.about')}}">About us</a></li>
								<li class="main_nav_item"><a href="{{\route('site.offers')}}">Offers</a></li>
				...
				<div class="owl-carousel owl-theme special_slider">
					...
					<div class="owl-item">
						<div class="special_item">
							...
							<div class="special_item_content text-center">
								...
								<div class="special_title"><a href="offers.blade.php">Indonesia</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							...
							<div class="special_item_content text-center">
								...
								<div class="special_title"><a href="offers.blade.php">India</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							...
							<div class="special_item_content text-center">
								...
								<div class="special_title"><a href="offers.blade.php">Thailand</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							...
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers.blade.php">Bali</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							...
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers.blade.php">France</a></div>
							</div>
						</div>
					</div>
